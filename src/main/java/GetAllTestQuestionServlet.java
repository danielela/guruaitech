...
public class GetAllTestQuestionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String test_question_query = "select t.*, count(tq.question_id) from onlinetest.Test t, onlinetest.TestQuestions tq where t.test_id=tq.test_id GROUP BY t.test_id";
